...
import API from "../services/axios"; // Make sure your Axios instance is correct
...
const NewsDetail = () => {
  ...
  // Update article when route changes
  useEffect(() => {
    if (!article && id) {
  ...
  // Determine the next article for the button
  ...
  const handleNextNews = () => {
    navigate(`/dashboard/news/${nextArticle._id}`, { state: { article: nextArticle, allArticles } });
